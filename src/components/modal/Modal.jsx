...
function Modal({ children, open, onClose }) {
  ...
  //   console.log("no hello",id);
  // })
  return ReactDom.createPortal(
    <div className="fixed modalhead  " onClick={onClose} data-aos="zoom-out">
      <div
        className="fixed modalbody z-50 rounded-lg bg-white"
        onClick={(e) => {
          e.stopPropagation();
        }}
      >
        <button
          onClick={onClose}
          className="absolute top-0 right-0 p-1 bg-red-500 text-4xl"
        >
          &times;
        </button>
        {children}
        {/* <div className="portalBody flex flex-row   pb-3 rounded-br-lg max-w-6xl  rounded-tr-lg">
              ...
              <div className="rightBox flex flex-col mt-3 text-left  mx-14 ">
                ...
                <small className="gray font-medium mb-2 text-wrap  ">
                  ...
                  implemented redux redux thunk etc Desc:This project i did when
                  i was studying react i have implemented redux redux thunk etc
                  Desc:This project i did when i was studying react i have
                  implemented redux redux thunk etc Desc:This project i did when
                  i was studying react i have implemented redux redux thunk etc
                  Desc:This project i did when i was studying react i have
